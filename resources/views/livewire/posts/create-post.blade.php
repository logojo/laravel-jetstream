<div>
    {{-- set es un metodo magico que me permite cambiar los valores de las variables definicas en la clase --}}
   ...
   <x-jet-dialog-modal wire:model="open">
    ...
    <x-slot name="content">
      ...
      {{-- Mostrando imagen temporal --}}       
       @if( $image )
        {{-- $image->temporaryUrl() almacena la url temporal de la imagen que se selecciono en el input --}}
        ...
        {{-- wire:ignore permite que cada ves se renderice la pagina, ignore esa seccion de codigo --}}
    ...
    <x-slot name="footer">
        ...
        <x-success-button class="ml-2" wire:click="save()" wire:loading.attr='disabled' wire:target='save, image' >
   ...
   @push('scripts')
    ...
    <script>
        ClassicEditor
            ...
            .then(function(editor){ // esta funcion se utiliza para renderizar el textarea y poder jalar los valores tecleados  ya que directamente no se esta rendirizando por usar wire:ignore
